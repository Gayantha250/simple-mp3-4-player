...
public class AppInitializer extends Application {
    ...
    private void mainScene(Stage stage) throws FileNotFoundException {
        ...
        Image imgBackground = new Image(this.getClass().getResource("/img/background.jpeg").toString());
        BackgroundSize bSize = new BackgroundSize(BackgroundSize.AUTO, BackgroundSize.AUTO, false, false, true, true);
        BackgroundImage bImg = new BackgroundImage(imgBackground, BackgroundRepeat.NO_REPEAT, BackgroundRepeat.NO_REPEAT, BackgroundPosition.DEFAULT, bSize);
